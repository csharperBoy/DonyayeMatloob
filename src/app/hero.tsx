      ...
      <div className="container mx-auto grid h-full min-h-[65vh] w-full grid-cols-1 place-items-center gap-y-10 lg:grid-cols-2">
        <div className="row-start-2 lg:row-auto lg:-mt-40">
          <Typography
            ...
            className="text-3xl !leading-snug text-red-500"
          >
            40% OFF
          </Typography>
          <Typography
            ...
            onPointerEnterCapture={undefined}
            onPointerLeaveCapture={undefined}
            className="mb-2 max-w-sm text-3xl !leading-snug text-blue-gray-900 lg:mb-3 lg:text-5xl"
          >
          ...
          <Typography
            ...
            onPointerEnterCapture={undefined}
            onPointerLeaveCapture={undefined}
            className="mb-6 text-lg font-normal !text-gray-500 md:pr-16 xl:pr-28"
          >
